...
{
    /// <summary>
    /// Représente un répertoire (dossier) virtuel à l'intérieur d'un fichier D2P.
    /// Un fichier D2P peut contenir des fichiers organisés en arborescence de dossiers,
    /// comme un ZIP. Cette classe modélise un nœud de cette arborescence.
    ///
    /// Exemple d'arborescence dans un D2P :
    ///   maps/
    ///     001/
    ///       1.dlm
    ///       2.dlm
    ...
    ///       3.dlm
    ///
    /// Chaque niveau est un D2pDirectory, et les fichiers sont des D2pEntry.
    /// </summary>

...
namespace Symbioz.World.Modules
{
    ...
    {
        public static string ItemsPath = AppDomain.CurrentDomain.BaseDirectory + "/Items.ma3";
        ...
        public static string MountsPath = AppDomain.CurrentDomain.BaseDirectory + "/Mounts.ma3";

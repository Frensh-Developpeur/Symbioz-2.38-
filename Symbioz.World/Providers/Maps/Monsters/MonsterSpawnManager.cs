...
{
    /// <summary>
    /// Singleton gérant la création des groupes de monstres sur les maps.
    ///
    /// Trois modes de spawn :
    ///   - SpawnMonsters : spawn initial au chargement de la map (1 à MaxMonsterGroupPerMap groupes)
    ///   - AddGeneratedMonsterGroup : spawn périodique basé sur les probabilités de la sous-zone
    ///   - AddFixedMonsterGroup : spawn script (quête, boss, commande admin) avec monstres précis
    ///
    /// La sélection aléatoire des monstres dans AddGeneratedMonsterGroup utilise une roue de
    /// la fortune pondérée par le champ Probability de MonsterSpawnRecord.
    /// </summary>
    public class MonsterSpawnManager : Singleton<MonsterSpawnManager>
    {
        ...
        /// <summary>
        /// Intervalle de spawn en secondes (multiplié par le nombre de groupes déjà présents)
        /// </summary>
        ...
        /// <summary>
        /// Spawn un groupe fixe avec des grades explicites par monstre.
        /// Les tableaux monsterRecords et grades doivent avoir la même longueur.
        /// </summary>
        ...
        // Vérifie si un groupe contenant exactement les monstres donnés existe déjà sur la map.
        // Utilisé pour éviter les doublons lors des spawns scriptés.
        ...
        // Retire de la map le premier groupe correspondant aux monstres donnés.
        // Utilisé par les scripts de quête ou les comportements de boss.

...
{
    /// <summary>
    /// Révèle les combattants invisibles dans la zone de l'effet.
    /// Ne fait rien si la cible est déjà visible.
    /// SetInvisiblityState notifie tous les combattants de la réapparition.
    /// </summary>
    ...
    public class RevealsInvisible : SpellEffectHandler
    {
        ...
        public override bool Apply(Fighter[] targets)
        {
            ...
            {
                // N'agit que sur les combattants réellement invisibles

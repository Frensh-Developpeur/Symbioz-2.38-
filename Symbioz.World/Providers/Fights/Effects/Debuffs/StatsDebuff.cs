...
namespace Symbioz.World.Providers.Fights.Effects.Debuffs
{
    ...
    /// <summary>
    /// Débuff de statistique temporaire : retire une valeur à une stat de la cible pendant N tours.
    /// Couvre une très large gamme (portée, sagesse, CC, résistances élémentaires, dommages...).
    /// N'applique l'effet que si Duration > 0 (sinon sans durée, le débuff n'a pas de sens).
    /// La valeur est toujours négative (-DiceMin) pour réduire la stat.
    /// </summary>
    public class StatsDebuff : SpellEffectHandler
    {
        ...
        // Retourne la Characteristic correspondant à l'effet de débuff

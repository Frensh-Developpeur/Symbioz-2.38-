...
{
    /// <summary>
    /// Transforme les dégâts reçus en soins : au lieu de perdre des HP, la cible en gagne.
    /// Chaque coup reçu soigne la cible du montant des dégâts (avant résistances).
    /// Retourne true = le buff se consomme après chaque coup (usage unique par attaque).
    /// Utilisé par des sorts de type "Contre" ou "Résilience".
    /// </summary>
    ...
    public class TakenDamageHeal : SpellEffectHandler
    {
        ...
        // Soigne la cible du montant des dégâts qu'elle aurait reçus

...
namespace Symbioz.World.Providers.Fights.Effects.Damages
{
    ...
    /// <summary>
    /// Inflige des dégâts élémentaires proportionnels aux PM utilisés par la cible en fin de tour.
    /// DiceMax = multiplicateur par PM utilisé (ex: DiceMax=10, 3 PM utilisés → 30 de jet de base).
    /// Le jet est ensuite amplifié par les stats élémentaires du lanceur.
    /// Utilisé par des sorts type "punition de déplacement" (Xélor, Roublard...).
    /// </summary>
    public class DamagePerMpUsed : SpellEffectHandler
    {
        ...
        {
            // Pose un buff qui se déclenche à la fin du tour de chaque cible
        ...
        {
            // Calcule les dégâts selon le nombre de PM utilisés ce tour

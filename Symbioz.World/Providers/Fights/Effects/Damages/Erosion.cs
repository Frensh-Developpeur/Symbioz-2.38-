...
{
    /// <summary>
    /// Érosion : réduit les HP maximum de la cible d'un pourcentage des dégâts reçus.
    /// L'ErosionBuff intercepte chaque coup reçu par la cible et diminue son HP max en proportion.
    /// DiceMin = pourcentage d'érosion (ex: 10 → chaque coup réduit les HP max de 10% des dégâts).
    /// Mécanisme clé du Sacrieur et de certains sorts endgame.
    /// </summary>

...
{
    /// <summary>
    /// Buff de Points d'Action.
    /// - Duration > 0 : buff temporaire (pose un StatBuff sur les PA, dissipable)
    /// - Duration == 0 : gain immédiat et permanent de PA pour ce tour (RegainAp)
    /// </summary>

...
{
    /// <summary>
    /// Armure magique : réduit les dégâts reçus d'une valeur fixe à chaque coup.
    /// Différent du bouclier (Shield) : le bouclier a un pool de HP absorbés,
    /// l'armure réduit chaque coup individuellement tant que le buff est actif.

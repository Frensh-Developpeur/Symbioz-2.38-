...
{
    /// <summary>
    /// Punition (Sacrieur) : chaque fois que la cible reçoit des dégâts, elle gagne
    /// une stat en proportion des dégâts reçus, jusqu'à un plafond (DiceMax).
    /// DiceMin encode la stat boostée (118=Force, 119=Agilité, 123=Chance, etc.).
    /// Le buff généré est REALLY_NOT_DISPELLABLE.
    /// </summary>
    ...
    public class Punishement : SpellEffectHandler
    {
        ...
        {
            // Pose un TriggerBuff sur chaque cible : se déclenche après chaque coup reçu
        ...
        // Appelé après chaque attaque reçue par la cible
        // Ajoute un buff de stat proportionnel aux dégâts de ce coup, sans dépasser DiceMax

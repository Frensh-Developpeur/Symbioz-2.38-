...
{
    /// <summary>
    /// Vol de statistique : retire une stat à la cible et la donne au lanceur.
    /// Ex: Vol de Force → cible perd X Force, lanceur gagne X Force pendant N tours.
    /// GetBuffDisplayedEffect retourne les IDs d'affichage corrects (Add vs Sub)
    /// pour que le client affiche la bonne icône sur chaque combattant.
    /// </summary>
    ...
    public class StatsSteal : SpellEffectHandler
    {
        ...
        public override bool Apply(Fighter[] targets)
        {
            foreach (Fighter current in targets)
            {
                ...
                // La cible perd la stat (valeur négative, affiché avec l'icône Sub)
                ...
                // Le lanceur gagne la stat (valeur positive, affiché avec l'icône Add)
        ...
        // Retourne la Characteristic correspondant à l'effet de vol

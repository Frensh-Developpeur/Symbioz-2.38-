...
{
    /// <summary>
    /// Buff de résistances élémentaires temporaires (tous les éléments à la fois).
    /// Pose un ResistancesBuff qui réduit les dégâts reçus de tous les éléments pendant N tours.
    /// N'est appliqué que si Duration > 0 (effet sans durée n'a pas de sens pour une résistance).
    /// </summary>

...
{
    /// <summary>
    /// Soin en pourcentage des HP max de la cible.
    /// Ex: DiceMin = 30 → soigne 30% des HP max de chaque cible.
    /// Contrairement à Heal, le montant dépend de la cible, pas du lanceur.
    /// </summary>
    ...
    public class RestoreHPPercent : SpellEffectHandler
    {
        ...
        public override bool Apply(Fighter[] targets)
        {
            ...
            {
                // Calcule X% des HP max de la cible (pas du lanceur)

...
{
    /// <summary>
    /// Téléporte le LANCEUR sur la cellule ciblée (CastPoint).
    /// Contrairement à SwitchPosition, seul le lanceur bouge.
    /// Utilisé par ex. pour les sorts de déplacement Iop, Xélor, Ecaflip...
    /// </summary>

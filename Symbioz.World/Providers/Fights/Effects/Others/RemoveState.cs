...
{
    /// <summary>
    /// Retire un état spécifique d'une cible.
    /// Effect.Value = l'ID de l'état à retirer (même ID que dans AddState).
    /// Utilisé pour annuler des états appliqués précédemment (ex: dissiper une bombe Roublard).
    /// </summary>

...
{
    /// <summary>
    /// Gestionnaire central de tous les combats actifs du serveur.
    /// Fonctionne en singleton. Permet de créer différents types de combats
    /// (PvM, PvP, arène, agression...) et de les référencer via un identifiant unique.
    /// Chaque combat créé est ajouté à la liste interne et retiré à sa fin (Dispose).
    /// </summary>
    public class FightProvider : Singleton<FightProvider>
    {
        // Liste de tous les combats actifs sur le serveur
        private List<Fight> Fights = new List<Fight>();

        /// <summary>
        /// Trouve un combat par son identifiant unique. Retourne null si introuvable.
        /// </summary>
        ...
        /// <summary>
        /// Retire un combat de la liste (appelé à la fin du combat lors du Dispose).
        /// </summary>
        ...
        /// <summary>
        /// Génère un identifiant unique pour un nouveau combat
        /// en cherchant dynamiquement un ID non utilisé dans la liste.
        ...
        /// <summary>
        /// Crée un combat PvM (Joueur contre Monstre) classique.
        /// L'équipe bleue = les monstres (défenseurs), l'équipe rouge = les joueurs (attaquants).
        /// </summary>

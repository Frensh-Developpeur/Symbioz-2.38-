...
{
    /// <summary>
    /// Implémentation des formules officielles de calcul d'expérience de combat (PvM).
    /// Portée depuis le fichier ActionScript d'Ankama (Ankama_UI => Tooltips > FormulasHandler.as).
    /// Calcule l'XP solo et en groupe en prenant en compte :
    ///   - Le niveau et l'XP des monstres tués
    ///   - La taille et le niveau du groupe de joueurs
    ///   - La sagesse du joueur, les bonus d'expérience, le bonus de monture, etc.
    /// </summary>
    public class ExperienceFormulas
    {
        // Coefficients multiplicateurs d'XP selon la taille du groupe (1 à 12 membres)
        static double[] XP_GROUP = new double[] { 1, 1.1, 1.5, 2.3, 3.1, 3.6, 4.2, 4.7, 4.9, 5.2, 6.3, 6.9 };

        // Malus maximum lié à la puissance des monstres par rapport au niveau du joueur
        private const double MAX_LEVEL_MALUS = 4;

        // XP calculée pour un joueur jouant seul
        public double _xpSolo { get; set; }
        // XP calculée pour un joueur en groupe (avec bonus de groupe)
        ...
        /// <summary>
        /// Calcule l'XP solo et groupe pour un joueur après un combat PvM.
        /// param1 = données du joueur (niveau, sagesse, multiplicateurs...)
        /// param2 = liste des monstres tués (niveau, XP)
        /// param3 = liste des membres du groupe (niveau, companion?)
        /// param4 = bonus âge du groupe de monstres (en %)
        /// param5 = multiplicateur de puissance des monstres
        /// Résultats stockés dans _xpSolo et _xpGroup.
        /// </summary>
        ...
        /// <summary>
        /// Données d'un monstre tué : son niveau et son XP de base.
        /// Le hiddenLevel est utilisé pour les monstres qui ont un niveau "caché" différent.
        /// </summary>
        public class MonsterData
        {
            ...
            public int xp;        // XP de base accordée par ce monstre
            public int level;     // Niveau affiché du monstre
            public int hiddenLevel; // Niveau réel (pour calculs internes), 0 si identique au level
        }

        /// <summary>
        /// Données d'un membre du groupe : son niveau et s'il est un compagnon (familier).
        /// Les compagnons comptent différemment dans le calcul de taille de groupe.
        /// </summary>
        public class GroupMemberData
        {
            ...
            public int level;    // Niveau du membre du groupe
            public bool companion; // true = c'est un compagnon/familier, pas un vrai joueur
        }

        /// <summary>
        /// Données du joueur pour le calcul d'XP : niveau, sagesse, et tous les bonus
        /// qui peuvent affecter l'expérience gagnée.
        /// </summary>
        public class PlayerData
        {
            ...
            public int wisdom;                    // Sagesse (augmente l'XP finale)
            public int xpBonusPercent;            // Bonus d'XP en % (parchemins, etc.)
            public int xpRatioMount;              // % d'XP donné à la monture
            public int xpGuildGivenPercent;       // % d'XP donné à la guilde
            public int xpAlliancePrismBonusPercent; // Bonus d'XP de l'alliance
            public int expMul;                    // Multiplicateur global d'XP (taux du serveur)
        }
    }

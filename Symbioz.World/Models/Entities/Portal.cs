...
{
    /// <summary>
    /// Portail de téléportation visible sur une map de jeu de rôle (hors combat).
    ///
    /// Un Portal est créé à partir d'un PortalRecord qui définit la destination de téléportation
    /// (TeleportMapId, TeleportCellId). Il est placé sur une cellule aléatoire non-bordure de la map.
    ///
    /// Quand un joueur marche sur la cellule du portail, Use() est appelé et le téléporte.
    /// </summary>
